let PROJECT_ID = "cr81p0a2xrtw";
let SIGNUP_URL = "https://academics.newtonschool.co/api/v1/bookingportals/signup";
let LOGIN_URL = "https://academics.newtonschool.co/api/v1/bookingportals/login";
